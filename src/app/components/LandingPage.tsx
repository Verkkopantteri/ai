...
/* ─── MINI CHAT WIDGET ────────────────────────────────────────── */
function MiniChat({ theme, isActive }: { theme: typeof CHAT_THEMES[0]; isActive: boolean }) {
  const messages = [
...
/* ─── CHAT STACK ──────────────────────────────────────────────── */
function ChatStack() {
  // Dark card is front-left, white card is behind-right, tilted slightly
  return (
    <div className="relative" style={{ width: 360, height: 560 }}>
      {/* Back card — Light theme, offset top-right, slight tilt */}
      <motion.div
        ...
        style={{
          ...
          right: 0,
          zIndex: 10,
          transform: 'rotate(4deg) translateX(18px) translateY(-14px)',
      ...
      {/* Front card — Dark theme, grounded */}
      <motion.div
...
function HeroSlide() {
  ...
  return (
    ...
    >
      ...
      {/* Split layout */}
      <div className="relative z-10 w-full max-w-7xl mx-auto px-10 flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16">
